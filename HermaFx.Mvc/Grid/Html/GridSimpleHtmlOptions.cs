...
namespace HermaFx.Mvc.Grid.Html
{
	...
	/// </summary>
	public class GridSimpleHtmlOptions<T> : IGridHtmlOptions<T> where T : class
	{
		private readonly GridSimple<T> _source;
		private readonly ViewContext _viewContext;

		public GridSimpleHtmlOptions(GridSimple<T> source, ViewContext viewContext, string viewName)
		{
			_source = source;
